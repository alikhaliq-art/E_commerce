    ...
    <div class="container_fluid">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary navbar-dark mb-2">
            <ul class="navbar-nav me-auto">
                ...
                if (!isset($_SESSION['user_username'])){
                    echo "<li class='nav-item'>
                    <a class='nav-link text-white' href='./user_area/profile.php'>Welcome Guest</a>
                </li>";
                }else{
                    echo"<li class='nav-item'>
                    <a class='nav-link text-white' href='./user_area/profile.php'>Welcome <strong class='text-warning'>".$_SESSION['user_username']."</strong> </a>
                    </li>";
                }
