...
<body>
    ...
    <div class="container">
        <table class="table table-striped table-bordered text-center">
            ...
            <tbody>
                <?php 
                $get_user_orders = "SELECT * FROM `user_orders` WHERE user_id='$user_id'";
                ...
                while ($row_orders=mysqli_fetch_assoc($user_order_result)) {
                    ...
                    if ($order_status == 'Complete') {
                        ...
                        echo "<td><a href='confirm_payment.php?order_id=$order_id' class='text-success cursor-pointer' tabindex='0'>Confirm</a></td>";
                    }
                    echo "</tr>";
                    $number++;
                }
